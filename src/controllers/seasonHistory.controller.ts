...
export const archiveSeason = async (req: Request, res: Response) => {
  try {
    ...
    return res.status(500).json({
      success: false,
      message:
        error instanceof Error ? error.message : "Lỗi khi lưu trữ mùa vụ",
    });
  }
};
...
export const getSeasonReport = async (req: Request, res: Response) => {
  try {
    ...
    return res.status(500).json({
      success: false,
      message:
        error instanceof Error ? error.message : "Lỗi khi tạo báo cáo mùa vụ",
    });
  }
};
    ...
    return res.status(500).json({
      ...
      message:
        error instanceof Error
          ? error.message
          : "Lỗi khi lấy danh sách lịch sử mùa vụ",
    });
  }
};
  ...
  try {
    ...
    return res.status(500).json({
      ...
      message:
        error instanceof Error
          ? error.message
          : "Lỗi khi lấy chi tiết lịch sử mùa vụ",
    });
  }
};
  ...
  try {
    ...
    return res.status(500).json({
      ...
      message:
        error instanceof Error
          ? error.message
          : "Lỗi khi cập nhật lịch sử mùa vụ",
    });
  }
};
