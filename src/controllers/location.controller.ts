...
export const createLocation = async (req: Request, res: Response) => {
  try {
    ...
    return res.status(500).json({
      success: false,
      message: error instanceof Error ? error.message : 'An error occurred while creating location'
    });
  }
};
...
export const getLocations = async (req: Request, res: Response) => {
  try {
    ...
    return res.status(500).json({
      success: false,
      message: error instanceof Error ? error.message : 'An error occurred while getting locations'
    });
  }
};
...
export const getLocationById = async (req: Request, res: Response) => {
  try {
    ...
    return res.status(500).json({
      success: false,
      message: error instanceof Error ? error.message : 'An error occurred while getting location'
    });
  }
};
...
export const updateLocation = async (req: Request, res: Response) => {
  try {
    ...
    return res.status(500).json({
      success: false,
      message: error instanceof Error ? error.message : 'An error occurred while updating location'
    });
  }
};
...
export const deleteLocation = async (req: Request, res: Response) => {
  try {
    ...
    const result = await locationService.deleteLocation(new mongoose.Types.ObjectId(locationId));
    ...
    return res.status(500).json({
      success: false,
      message: error instanceof Error ? error.message : 'An error occurred while deleting location'
    });
  }
};